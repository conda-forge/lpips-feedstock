...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lpips-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12841&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lpips-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lpips` can be installed with:

```
conda install lpips
```

It is possible to list all of the versions of `lpips` available on your platform with:
